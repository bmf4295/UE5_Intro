...
static const FName NAME_AToonTanksGameMode_GameOver = FName(TEXT("GameOver"));
...
static const FName NAME_AToonTanksGameMode_StartGame = FName(TEXT("StartGame"));
...
struct Z_CompiledInDeferFile_FID_ToonTanks_Source_ToonTanks_ToonTanksGameMode_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AToonTanksGameMode, AToonTanksGameMode::StaticClass, TEXT("AToonTanksGameMode"), &Z_Registration_Info_UClass_AToonTanksGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AToonTanksGameMode), 4028839264U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ToonTanks_Source_ToonTanks_ToonTanksGameMode_h_3176202059(TEXT("/Script/ToonTanks"),
